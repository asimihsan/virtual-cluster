...
RUN wget https://github.com/antlr/antlr4/archive/refs/tags/4.12.0.tar.gz && \
...
FROM maven:3.9.1-amazoncorretto-17-debian-bullseye as antlr-build
...
RUN java -jar /app/antlr4-4.12.0-complete.jar -Dlanguage=Go -no-listener -visitor -o /app/generated/vcluster grammar/VCluster.g4 && \
    java -jar /app/antlr4-4.12.0-complete.jar -Dlanguage=Go -no-listener -visitor -o /app/generated/services grammar/Services.g4
